...
import com.canonfer.ecatalog.activities.CameraActivity;
...
import com.canonfer.ecatalog.util.SystemUiHider;
...
/*
		...
		Button bottomButton = (Button)findViewById(R.id.dummy_button);
      

		bottomButton.setOnTouchListener(mDelayHideTouchListener);
		bottomButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	
        
                Bitmap image =((BitmapDrawable)mContainer.getDrawable()).getBitmap();
                
            	Log.i(LogTag, "Onclick Button LaunchAsynTask");
            	ImageProcessorTask procesor=new ImageProcessorTask();
            	procesor.delegate=MainActivity.this;
            	procesor.execute(image);
            }
        });
		
		Uri textUrl = getIntent().getData();	

        Bundle extras = getIntent().getExtras();

        mContainer= (ImageView)findViewById(R.id.imageView1);
        
        if(textUrl != null){
     
     	  new DownloadImageTask((ImageView) findViewById(R.id.imageView1)).execute(textUrl.toString());
     	
        }else{	
		 
		mContainer.setImageResource(R.drawable.apple);
        }
		mContainer.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				case 1:
					...
					break;
				case 2:
					mContainer.setImageResource(R.drawable.watch);
					LastUsed=3;
					break;
				case 3:
					mContainer.setImageResource(R.drawable.gpdpzoom);
					LastUsed=4;
				break;
				
				case 4:
					mContainer.setImageResource(R.drawable.yoda);
					LastUsed=1;
				break;
				default:
					mContainer.setImageResource(R.drawable.apple);
